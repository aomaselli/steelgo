      ...
      <div className="p-6 space-y-6">
        ...
        <Card className="overflow-hidden">
          {isLoading ? (
            ...
            <EmptyState icon={FileText} title="Nenhum contrato" description="Envie propostas no marketplace para fechar contratos." />
          ) : (
            <table className="w-full text-sm">
              <thead className="bg-bg-elevated text-xs uppercase text-graphite-400">
                <tr>
                  ...
                  <th className="text-left px-4 py-2">Embarcador</th>
                ...
                {data.map((c) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-graphite-200">{sh?.name ?? "—"}</td>
